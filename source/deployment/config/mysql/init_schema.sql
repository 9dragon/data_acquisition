...
CREATE TABLE `t_permission`  (
  ...
  `type` enum('menu','button','api') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'button' COMMENT '权限类型',
...
CREATE TABLE `t_role`  (
  ...
  `permissions` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限ID列表，逗号分隔',
...
CREATE TABLE `t_user`  (
  ...
  `role_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '角色ID列表（逗号分隔）',
  `status` int(0) NULL DEFAULT 1 COMMENT '状态：0=禁用, 1=启用',
